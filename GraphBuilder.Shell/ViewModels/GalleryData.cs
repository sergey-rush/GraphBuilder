        ...
        public ObservableCollection<GalleryCategoryData> CategoryDataCollection
        {
            get
            {
                if (_controlDataCollection == null)
                {
                    ...
                    Uri smallImage = new Uri("/GraphBuilder.Shell;component/Images/Paste_16x16.png", UriKind.Relative);
                    Uri largeImage = new Uri("/GraphBuilder.Shell;component/Images/Paste_32x32.png", UriKind.Relative);
