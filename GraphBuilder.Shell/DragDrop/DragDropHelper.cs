...
namespace GraphBuilder.Shell.DragDrop
{
    public class DragDropHelper
    {
        ...
        // target
        private ContentControl _targetItemsControl;
        ...
        private static void IsDropTargetChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
        {
            ...
            var dropTarget = obj as ContentControl;
            if (dropTarget != null)
            {
                if (Equals(e.NewValue, true))
                {
        ...
        {
            _targetItemsControl = (ContentControl)sender;
            ...
            if (draggedItem != null)
            {
                ...
                //ScrollIntoView(_targetItemsControl, position);
        ...
        private void DecideDropTarget(DragEventArgs e)
        {
            ...
            //        {
            //            Debug.WriteLine("TargetItemContainer NULL");
            //        }
            //        else
            //        {
            //            Debug.WriteLine("TargetItemContainer" + _targetItemContainer.ToString());
            //        }
