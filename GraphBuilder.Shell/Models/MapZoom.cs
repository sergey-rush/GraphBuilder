...
namespace GraphBuilder.Shell.Models
{
    ...
    /// </summary>
    internal class MapZoom : Animatable
    {
        ...
        /// </summary>
        public static readonly DependencyProperty ZoomToPointProperty = DependencyProperty.Register("ZoomToPoint",
            typeof (double), typeof (MapZoom));

        /// <summary>
        /// When we are zooming to a rectangle this property can be animated.
        /// </summary>
        public static readonly DependencyProperty ZoomToRectProperty = DependencyProperty.Register("ZoomToRect",
            typeof (double), typeof (MapZoom));
